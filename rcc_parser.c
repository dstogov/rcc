...
static yy_sym parse_declaration_specifiers(yy_sym sym, rcc_ctx *rcc, c_dcl *d) {
	do {
		...
		} else if (sym == YY_INLINE || sym == YY___INLINE || sym == YY___INLINE__ || sym == YY__NORETURN || sym == YY___CDECL || sym == YY___FASTCALL) {
